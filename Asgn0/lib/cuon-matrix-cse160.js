...
class Vector3 {
    ...
    static cross(other1, other2) {
        ...
        v3.elements[0] = y1 * z2 - z1 * y2; // x component
        v3.elements[1] = z1 * x2 - x1 * z2; // y component
        v3.elements[2] = x1 * y2 - y1 * x2; // z component

        // y1z1 - z1y2, z1x2 - x1z2, x1y2 - y1x2
        // Don't delete the return statement.
        return v3;
    }
